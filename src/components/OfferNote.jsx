export default function OfferNote() {
  return (
    <div className="mt-4 rounded-[22px] border border-white/8 bg-[#2B3132] px-4 py-3 text-white/80 shadow-[0_10px_24px_rgba(0,0,0,0.12)] md:mt-5 md:max-w-[560px] md:px-5 md:py-3.5">
