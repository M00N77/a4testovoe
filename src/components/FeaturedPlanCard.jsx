...
export default function FeaturedPlanCard({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute right-4 top-4 text-[13px] font-semibold uppercase tracking-[0.12em] text-[#F6A74B] min-[970px]:right-5 min-[970px]:text-[14px] xl:right-7 xl:top-5 xl:text-[16px]"
      >
        ХИТ!
      </span>

      <div className="flex h-full flex-1 flex-col gap-4 pt-2 min-[970px]:grid min-[970px]:grid-cols-[minmax(220px,260px)_minmax(0,1fr)] min-[970px]:items-center min-[970px]:gap-5 min-[970px]:pt-0 xl:grid-cols-[minmax(260px,300px)_minmax(0,1fr)] xl:gap-6">
